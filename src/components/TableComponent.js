              ...
              return (
                ...
                >
                  <td className="py-3 flex items-center uppercase">
                    <button className="border-0 ml-11 outline-0 bg-none cursor-pointer">
                      <svg
                        className="w-[1.5rem] fill-gray-100 hover:fill-cyan"
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
                        fill="cyan"
                    ...
                    <img
                      src={data.image}
                      className="w-[2.2rem]  h-[2.2rem] mx-2"
                      alt={data.name}
                    />
                    <span>{data.symbol}</span>
                  </td>
                  <td className="py-3 capitalize">{data.id}</td>
                  <td className="py-3">
